 ...
 */
final class Version20180624155901 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task ADD CONSTRAINT FK_527EDB25D9AEC3CF FOREIGN KEY (frequency_unit_id) REFERENCES frequency_unit (id)');

        $this->addSql('INSERT INTO frequency_unit VALUES (1, "day(s)"), (2, "week(s)"), (3, "month(s)")');
    }
